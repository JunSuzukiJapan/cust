...
impl ParserError {
    ...
    pub fn no_such_a_union(name: &str, pos: Position) -> ParserError {
        ParserError::NoSuchAUnion(name.to_string(), pos)
    }
...
impl fmt::Display for ParserError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            Self::NoSuchAUnion(name, _pos) => write!(f, "no such a union '{}'", name),
