...
use crate::parser::{AST, ToplevelAST, ExprAST, BinOp, Type, Pointer, Block, Params, NumberType, Function, FunProto, FunOrProt};
use crate::parser::{Declaration, DeclarationSpecifier, CustFunctionType, Initializer, ImplElement, SpecifierQualifier, EnumLiteral};
use crate::env::Class;
...
use inkwell::values::{AnyValue, AnyValueEnum, BasicMetadataValueEnum, BasicValue, BasicValueEnum, FunctionValue, GlobalValue, InstructionOpcode, PointerValue, StructValue};
...
impl<'ctx> CodeGen<'ctx> {
    ...
    pub fn const_expr_to_basic_value_enum(&self, const_expr: &ConstExpr, _context: &Context) -> BasicValueEnum {
        match const_expr {
            ConstExpr::Int(n, _) => {
                let i32_type = self.context.i32_type();
